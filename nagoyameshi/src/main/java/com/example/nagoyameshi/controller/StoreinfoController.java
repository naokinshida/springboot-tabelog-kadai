...
public class StoreinfoController {
    ...
    public String show(@PathVariable(name = "id") Integer storeId,  
        ...
        if (userDetails != null) {
            isFavorite = favoriteService.isFavorite(userDetails.getMemberinfo().getId().longValue(), storeId.longValue());
        }
    ...
    public String addFavorite(@PathVariable("id") Long storeId,
        ...
        if (!favoriteService.isFavorite(memberinfo.getId(), storeId)) {
            Favorite favorite = new Favorite();
            favorite.setStoreId(storeId);
            favorite.setUserId((int) memberinfo.getId().longValue());
    ...
    public String viewFavorites(@AuthenticationPrincipal UserDetailsImpl userDetails, Model model) {
        ...
        Memberinfo memberinfo = userDetails.getMemberinfo();
        List<Favorite> favorites = favoriteService.getFavoritesByUserId(memberinfo.getId().longValue());
